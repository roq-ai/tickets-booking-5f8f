...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Tickets Booking Application`}</title>

        <meta
          name="description"
          content="Welcome to Tickets Booking Application - Your one-stop destination for booking train, flight, and bus tickets online. Rated as one of the highest, we ensure your journey starts here!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1682685796467-89a6f149f07a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHx0cmF2ZWx8ZW58MHx8fHwxNjk1NzA4NTYzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Tickets Booking Application - Your one-stop destination for booking train, flight, and bus tickets online. Rated as one of the highest, we ensure your journey starts here!`}
            </Text>
            <Box
