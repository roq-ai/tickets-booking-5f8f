        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Ticket Type" text={data?.ticket_type} />
                ...
                <FormListItem
                  ...
                  text={
                    data?.departure_time
                      ? format(parseISO(data?.departure_time as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  label="Arrival Time"
                  text={
                    data?.arrival_time ? format(parseISO(data?.arrival_time as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
