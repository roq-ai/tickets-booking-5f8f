...
export function TicketListPage(props: TicketListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTickets({
        relations: ['provider', 'booking.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['ticket_type.contains', 'origin.contains', 'destination.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'ticket_type', header: 'Ticket Type', accessorKey: 'ticket_type' },
    { id: 'price', header: 'price', accessorKey: 'price' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.departure_time ? format(parseISO(record?.departure_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'arrival_time',
      header: 'Arrival Time',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.arrival_time ? format(parseISO(record?.arrival_time as unknown as string), 'dd-MM-yyyy') : '',
    },
